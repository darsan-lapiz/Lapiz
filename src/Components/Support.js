        ...
        <div className="h-screen m-[10px] py-[10px]">
            <div className=" align-center text-center justify-center-screen max-h-[500px]">
               ...
               <Card 
                ...
                <div>
                    <p>Would Like to Join Us</p>
                    <p>Tell us how you qualify and prove you are from underresourced region.Write us an email with your CV and describing why you want to get mentorship from us</p>
                </div>
            </div>
        </div>
        </>
